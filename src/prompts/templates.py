...
prompt_text = mcq_prompt_template.format(topic="Photosynthesis", difficulty="easy")
print(prompt_text)

'''
'''
as the model is having less parameters so will give our model example so that it can understand
'''